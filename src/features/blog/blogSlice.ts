...
export const createBlog = createAsyncThunk(
  "blog/createBlog",
  async ({ title, content, createDate }: CreateBlogType) => {
    const res = await axios.get("http://localhost:3001/blogs");
...
export const createSelectedBlog = createAsyncThunk(
  "blog/createSelectedBlog",
  async ({
    id,
    title,
    content,
    ...
    await axios
      .post("http://localhost:3001/selectedBlog", {
        id: id,
        title: title,
        content: content,
        createDate: createDate,
...
export const changeCompleted = createAsyncThunk(
  ...
  async ({
    ...
    await axios.put(`http://localhost:3001/selectedBlog/`, editedSelectedBlog);
    await axios.put(
      `http://localhost:3001/blogs/${selectedId}`,
      editedSelectedBlog
    );
...
export const selectBlogs = (state: RootState): BlogState["blogs"] =>
  state.blog.blogs;
export const selectSelectedBlog = (
  state: RootState
): BlogState["selectedBlog"] => state.blog.selectedBlog;
export const selectIsModalOpen = (state: RootState): BlogState["isModalOpen"] =>
